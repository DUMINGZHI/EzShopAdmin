<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\xampp\htdocs\shop./application/index\view\category\category.htm";i:1524140562;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div class="dsc-choie dsc-cm">
		...
		<div class="ui-areamini-content-wrap" id="ui-content-wrap">
			...
			<li data-id="1" data-name="A">
					...
					<a href="#" >阿克苏</a>
					<a href="#" >阿拉尔</a>
					<a href="#" class="is_district">澳门</a>
					</div>
						</li>
			<li data-id="2" data-name="B">
							<em>B</em>
							<div class="itme-city">
						<a href="#" class="city_selected">蚌埠</a>
					<a href="#" >亳州</a>
					<a href="#" >北京</a>
					<a href="#" >白银</a>
					<a href="#" >百色</a>
			...
			<li data-id="8" data-name="H">
					...
					<a href="#" >呼和浩特</a>
					<a href="#" >呼伦贝尔</a>
					<a href="#" class="is_district">海北</a>
					<a href="#" class="is_district">海东</a>
					<a href="#" class="is_district">海南</a>
					<a href="#" class="is_district">海西</a>
					<a href="#" class="is_district">黄南</a>
					<a href="#" >菏泽</a>
					<a href="#" >汉中</a>
					<a href="#" >哈密</a>
					<a href="#" >和田</a>
			...
			<li data-id="20" data-name="X">
					...
					<a href="#" >锡林郭勒盟</a>
					<a href="#" >兴安盟</a>
					<a href="#" class="is_district">西宁</a>
					<a href="#" >忻州</a>
					<a href="#" >西安</a>
					<a href="#" >咸阳</a>
					<a href="#" >西双版纳</a>
					<a href="#" class="is_district">香港</a>
					</div>
						</li>
