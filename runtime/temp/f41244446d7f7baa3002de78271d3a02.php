<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"E:\xampp\htdocs\shop./application/admin\view\cate\add.htm";i:1521897063;s:58:"E:\xampp\htdocs\shop\application\admin\view\common\top.htm";i:1521462190;s:59:"E:\xampp\htdocs\shop\application\admin\view\common\left.htm";i:1523363009;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="control-group">
                                    <div class="radio">
                                        <label>
                                            <input name="show_nav" value="1" type="radio" checked="checked" class="colored-blue">
                                            <span class="text">是</span>
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="show_nav" value="0" type="radio" class="colored-blue">
