<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\xampp\htdocs\shop./application/admin\view\article\add.htm";i:1522072052;s:58:"E:\xampp\htdocs\shop\application\admin\view\common\top.htm";i:1521462190;s:59:"E:\xampp\htdocs\shop\application\admin\view\common\left.htm";i:1523363009;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <select name="cate_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>"><?php echo str_repeat("-",$vo['level']*5);?><?php echo $vo['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="control-group">
                                    <div class="radio">
                                        <label>
                                            <input name="show_top" value="1" type="radio" checked="checked" class="colored-blue">
                                            <span class="text">是</span>
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input name="show_top" value="0" type="radio" class="colored-blue">
